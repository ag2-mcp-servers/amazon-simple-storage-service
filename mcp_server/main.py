...
from models import (
    ...
    XAmzChecksumMode,
    XAmzFwdHeaderXAmzObjectLockLegalHold,
    XAmzFwdHeaderXAmzObjectLockMode,
    XAmzFwdHeaderXAmzReplicationStatus,
    XAmzFwdHeaderXAmzRequestCharged,
    XAmzFwdHeaderXAmzServerSideEncryption,
    XAmzFwdHeaderXAmzStorageClass,
    XAmzMetadataDirective,
    XAmzObjectAttributes,
    XAmzObjectLockLegalHold,
    XAmzObjectLockMode,
    XAmzObjectOwnership,
    XAmzRequestPayer,
    XAmzSdkChecksumAlgorithm,
...
@app.post(
    ...
    tags=[
        'object_management_operations',
        'bucket_replication_settings',
...
def write_get_object_response(
    x_amz_request_route: str = Header(..., alias='x-amz-request-route'),
    x_amz_request_token: str = Header(..., alias='x-amz-request-token'),
    x_amz_fwd_status: Optional[int] = Header(None, alias='x-amz-fwd-status'),
    x_amz_fwd_error_code: Optional[str] = Header(None, alias='x-amz-fwd-error-code'),
    x_amz_fwd_error_message: Optional[str] = Header(
        None, alias='x-amz-fwd-error-message'
    ),
    x_amz_fwd_header_accept_ranges: Optional[str] = Header(
        None, alias='x-amz-fwd-header-accept-ranges'
    ),
    x_amz_fwd_header__cache__control: Optional[str] = Header(
        None, alias='x-amz-fwd-header-Cache-Control'
    ),
    x_amz_fwd_header__content__disposition: Optional[str] = Header(
        None, alias='x-amz-fwd-header-Content-Disposition'
    ),
    x_amz_fwd_header__content__encoding: Optional[str] = Header(
        None, alias='x-amz-fwd-header-Content-Encoding'
    ),
    x_amz_fwd_header__content__language: Optional[str] = Header(
        None, alias='x-amz-fwd-header-Content-Language'
    ),
    content__length: Optional[int] = Header(None, alias='Content-Length'),
    x_amz_fwd_header__content__range: Optional[str] = Header(
        None, alias='x-amz-fwd-header-Content-Range'
    ),
    x_amz_fwd_header__content__type: Optional[str] = Header(
        None, alias='x-amz-fwd-header-Content-Type'
    ),
    x_amz_fwd_header_x_amz_checksum_crc32: Optional[str] = Header(
        None, alias='x-amz-fwd-header-x-amz-checksum-crc32'
    ),
    x_amz_fwd_header_x_amz_checksum_crc32c: Optional[str] = Header(
        None, alias='x-amz-fwd-header-x-amz-checksum-crc32c'
    ),
    x_amz_fwd_header_x_amz_checksum_sha1: Optional[str] = Header(
        None, alias='x-amz-fwd-header-x-amz-checksum-sha1'
    ),
    x_amz_fwd_header_x_amz_checksum_sha256: Optional[str] = Header(
        None, alias='x-amz-fwd-header-x-amz-checksum-sha256'
    ),
    x_amz_fwd_header_x_amz_delete_marker: Optional[bool] = Header(
        None, alias='x-amz-fwd-header-x-amz-delete-marker'
    ),
    x_amz_fwd_header__e_tag: Optional[str] = Header(
        None, alias='x-amz-fwd-header-ETag'
    ),
    x_amz_fwd_header__expires: Optional[datetime] = Header(
        None, alias='x-amz-fwd-header-Expires'
    ),
    x_amz_fwd_header_x_amz_expiration: Optional[str] = Header(
        None, alias='x-amz-fwd-header-x-amz-expiration'
    ),
    x_amz_fwd_header__last__modified: Optional[datetime] = Header(
        None, alias='x-amz-fwd-header-Last-Modified'
    ),
    x_amz_fwd_header_x_amz_missing_meta: Optional[int] = Header(
        None, alias='x-amz-fwd-header-x-amz-missing-meta'
    ),
    x_amz_fwd_header_x_amz_object_lock_mode: Optional[
        XAmzFwdHeaderXAmzObjectLockMode
    ] = Header(None, alias='x-amz-fwd-header-x-amz-object-lock-mode'),
    x_amz_fwd_header_x_amz_object_lock_legal_hold: Optional[
        XAmzFwdHeaderXAmzObjectLockLegalHold
    ] = Header(None, alias='x-amz-fwd-header-x-amz-object-lock-legal-hold'),
    x_amz_fwd_header_x_amz_object_lock_retain_until_date: Optional[datetime] = Header(
        None, alias='x-amz-fwd-header-x-amz-object-lock-retain-until-date'
    ),
    x_amz_fwd_header_x_amz_mp_parts_count: Optional[int] = Header(
        None, alias='x-amz-fwd-header-x-amz-mp-parts-count'
    ),
    x_amz_fwd_header_x_amz_replication_status: Optional[
        XAmzFwdHeaderXAmzReplicationStatus
    ] = Header(None, alias='x-amz-fwd-header-x-amz-replication-status'),
    x_amz_fwd_header_x_amz_request_charged: Optional[
        XAmzFwdHeaderXAmzRequestCharged
    ] = Header(None, alias='x-amz-fwd-header-x-amz-request-charged'),
    x_amz_fwd_header_x_amz_restore: Optional[str] = Header(
        None, alias='x-amz-fwd-header-x-amz-restore'
    ),
    x_amz_fwd_header_x_amz_server_side_encryption: Optional[
        XAmzFwdHeaderXAmzServerSideEncryption
    ] = Header(None, alias='x-amz-fwd-header-x-amz-server-side-encryption'),
    x_amz_fwd_header_x_amz_server_side_encryption_customer_algorithm: Optional[
        str
    ] = Header(
        None, alias='x-amz-fwd-header-x-amz-server-side-encryption-customer-algorithm'
    ),
    x_amz_fwd_header_x_amz_server_side_encryption_aws_kms_key_id: Optional[
        SecretStr
    ] = Header(
        None, alias='x-amz-fwd-header-x-amz-server-side-encryption-aws-kms-key-id'
    ),
    x_amz_fwd_header_x_amz_server_side_encryption_customer_key__m_d5: Optional[
        str
    ] = Header(
        None, alias='x-amz-fwd-header-x-amz-server-side-encryption-customer-key-MD5'
    ),
    x_amz_fwd_header_x_amz_storage_class: Optional[
        XAmzFwdHeaderXAmzStorageClass
    ] = Header(None, alias='x-amz-fwd-header-x-amz-storage-class'),
    x_amz_fwd_header_x_amz_tagging_count: Optional[int] = Header(
        None, alias='x-amz-fwd-header-x-amz-tagging-count'
    ),
    x_amz_fwd_header_x_amz_version_id: Optional[str] = Header(
        None, alias='x-amz-fwd-header-x-amz-version-id'
    ),
    x_amz_fwd_header_x_amz_server_side_encryption_bucket_key_enabled: Optional[
        bool
    ] = Header(
        None, alias='x-amz-fwd-header-x-amz-server-side-encryption-bucket-key-enabled'
    ),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.delete(
    '/{Bucket}',
    description=""" <p>Deletes the S3 bucket. All objects (including all object versions and delete markers) in the bucket must be deleted before the bucket itself can be deleted.</p> <p class="title"> <b>Related Resources</b> </p> <ul> <li> <p> <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_CreateBucket.html">CreateBucket</a> </p> </li> <li> <p> <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_DeleteObject.html">DeleteObject</a> </p> </li> </ul> """,
    tags=['bucket_existence_check', 'bucket_ownership_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def delete_bucket(
    bucket: str = Path(..., alias='Bucket'),
    x_amz_expected_bucket_owner: Optional[str] = Header(
        None, alias='x-amz-expected-bucket-owner'
    ),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.get(
    ...
    tags=['object_listing_operations', 'object_listing_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def list_objects(
    ...
    encoding_type: Optional[EncodingType] = Query(None, alias='encoding-type'),
    marker: Union[Optional[str], Optional[str], Optional[str], Optional[str]] = None,
    max_keys: Union[Optional[int], Optional[str], Optional[str], Optional[str]] = Query(
        None, alias='max-keys'
    ),
    prefix: Optional[str] = None,
    x_amz_request_payer: Optional[XAmzRequestPayer] = Header(
        None, alias='x-amz-request-payer'
    ),
    x_amz_expected_bucket_owner: Optional[str] = Header(
        None, alias='x-amz-expected-bucket-owner'
    ),
...
@app.put(
    ...
    tags=['bucket_acl_management', 'bucket_ownership_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def create_bucket(
    ...
    x_amz_object_ownership: Optional[XAmzObjectOwnership] = Header(
        None, alias='x-amz-object-ownership'
    ),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.get(
    ...
    tags=[
        'bucket_acceleration_settings',
        'bucket_existence_check',
        'bucket_ownership_control',
    ],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
def put_bucket_accelerate_configuration(
    ...
    x_amz_sdk_checksum_algorithm: Optional[XAmzSdkChecksumAlgorithm] = Header(
        None, alias='x-amz-sdk-checksum-algorithm'
    ),
    accelerate: Accelerate = ...,
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
...
@app.put(
    ...
    tags=['bucket_acl_management', 'bucket_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['bucket_analytics_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.delete(
    ...
    tags=['bucket_cors_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['object_deletion_operations', 'bucket_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def delete_objects(
    ...
    x_amz_bypass_governance_retention: Optional[bool] = Header(
        None, alias='x-amz-bypass-governance-retention'
    ),
    x_amz_expected_bucket_owner: Optional[str] = Header(
        None, alias='x-amz-expected-bucket-owner'
    ),
...
@app.delete(
    ...
    tags=['bucket_encryption_settings'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.put(
    ...
    tags=['bucket_encryption_settings', 'bucket_policy_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['bucket_intelligent_tiering'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def list_bucket_intelligent_tiering_configurations(
    bucket: str = Path(..., alias='Bucket'),
    continuation_token: Optional[str] = Query(None, alias='continuation-token'),
    intelligent_tiering: IntelligentTiering = Query(..., alias='intelligent-tiering'),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.get(
    ...
    tags=['bucket_inventory_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.delete(
    ...
    tags=['bucket_lifecycle_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
def list_objects_v2(
    ...
    prefix: Optional[str] = None,
    continuation_token: Union[
        Optional[str], Optional[str], Optional[str], Optional[str]
    ] = Query(None, alias='continuation-token'),
    ...
    list_type: ListType = Query(..., alias='list-type'),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.get(
    ...
    tags=['bucket_location_retrieval', 'bucket_ownership_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['bucket_logging_configuration', 'bucket_ownership_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.put(
    ...
    tags=['bucket_management', 'bucket_logging_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['bucket_metrics_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['bucket_metrics_configuration', 'bucket_existence_check'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.put(
    ...
    tags=['bucket_management', 'bucket_metrics_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    '/{Bucket}#notification',
    description=""" <p>Returns the notification configuration of a bucket.</p> <p>If notifications are not enabled on the bucket, the action returns an empty <code>NotificationConfiguration</code> element.</p> <p>By default, you must be the bucket owner to read the notification configuration of a bucket. However, the bucket owner can use a bucket policy to grant permission to other users to read this configuration with the <code>s3:GetBucketNotification</code> permission.</p> <p>For more information about setting and reading the notification configuration on a bucket, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html">Setting Up Notification of Bucket Events</a>. For more information about bucket policies, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/using-iam-policies.html">Using Bucket Policies</a>.</p> <p>The following action is related to <code>GetBucketNotification</code>:</p> <ul> <li> <p> <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketNotification.html">PutBucketNotification</a> </p> </li> </ul> """,
    tags=['bucket_notification_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
def put_bucket_notification_configuration(
    ...
    x_amz_skip_destination_validation: Optional[bool] = Header(
        None, alias='x-amz-skip-destination-validation'
    ),
    notification: Notification = ...,
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
...
@app.get(
    ...
    tags=['object_lock_configuration', 'bucket_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def get_object_lock_configuration(
    ...
    object_lock: ObjectLock = Query(..., alias='object-lock'),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.put(
    ...
    tags=['bucket_request_payment_configuration', 'object_lock_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def put_object_lock_configuration(
    ...
    x_amz_bucket_object_lock_token: Optional[str] = Header(
        None, alias='x-amz-bucket-object-lock-token'
    ),
    content__m_d5: Optional[str] = Header(None, alias='Content-MD5'),
    x_amz_sdk_checksum_algorithm: Optional[XAmzSdkChecksumAlgorithm] = Header(
        None, alias='x-amz-sdk-checksum-algorithm'
...
def delete_bucket_ownership_controls(
    ...
    ownership_controls: OwnershipControls1 = Query(..., alias='ownershipControls'),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def put_bucket_ownership_controls(
    ...
    ownership_controls: OwnershipControls7 = Query(..., alias='ownershipControls'),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.delete(
    ...
    tags=['bucket_policy_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['bucket_policy_configuration', 'bucket_ownership_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.put(
    ...
    tags=['bucket_policy_configuration', 'bucket_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
def get_bucket_policy_status(
    ...
    policy_status: PolicyStatus1 = Query(..., alias='policyStatus'),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def delete_public_access_block(
    ...
    public_access_block: PublicAccessBlock = Query(..., alias='publicAccessBlock'),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.get(
    ...
    tags=['public_access_block_settings', 'bucket_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.delete(
    ...
    tags=['bucket_replication_settings'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.put(
    ...
    tags=['bucket_replication_settings', 'bucket_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['bucket_request_payment_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def get_bucket_request_payment(
    ...
    request_payment: RequestPayment = Query(..., alias='requestPayment'),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.delete(
    ...
    tags=['bucket_tagging_operations', 'bucket_ownership_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['bucket_tagging_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['multipart_upload_management', 'object_management_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def list_multipart_uploads(
    ...
    key_marker: Union[
        Optional[str], Optional[str], Optional[str], Optional[str]
    ] = Query(None, alias='key-marker'),
    max_uploads: Union[
        Optional[int], Optional[str], Optional[str], Optional[str]
    ] = Query(None, alias='max-uploads'),
    prefix: Optional[str] = None,
    upload_id_marker: Union[
        Optional[str], Optional[str], Optional[str], Optional[str]
    ] = Query(None, alias='upload-id-marker'),
    x_amz_expected_bucket_owner: Optional[str] = Header(
        None, alias='x-amz-expected-bucket-owner'
    ),
    uploads: Uploads = ...,
...
@app.put(
    ...
    tags=['bucket_management', 'bucket_versioning_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['bucket_listing_operations', 'object_listing_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def list_object_versions(
    ...
    prefix: Optional[str] = None,
    version_id_marker: Union[
        Optional[str], Optional[str], Optional[str], Optional[str]
    ] = Query(None, alias='version-id-marker'),
    x_amz_expected_bucket_owner: Optional[str] = Header(
        None, alias='x-amz-expected-bucket-owner'
    ),
    versions: Versions = ...,
...
@app.delete(
    ...
    tags=['bucket_website_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.put(
    ...
    tags=['bucket_website_configuration', 'bucket_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.delete(
    ...
    tags=['object_management_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def delete_object(
    bucket: str = Path(..., alias='Bucket'),
    key: constr(min_length=1) = Path(..., alias='Key'),
    x_amz_mfa: Optional[str] = Header(None, alias='x-amz-mfa'),
...
@app.get(
    ...
    tags=[
        'object_management_operations',
        'multipart_upload_management',
        'object_content_retrieval',
    ],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
def get_object(
    ...
    if__unmodified__since: Optional[datetime] = Header(
        None, alias='If-Unmodified-Since'
    ),
    key: constr(min_length=1) = Path(..., alias='Key'),
    range: Optional[str] = Header(None, alias='Range'),
    response_cache_control: Optional[str] = Query(None, alias='response-cache-control'),
    response_content_disposition: Optional[str] = Query(
        None, alias='response-content-disposition'
    ),
    response_content_encoding: Optional[str] = Query(
        None, alias='response-content-encoding'
    ),
    response_content_language: Optional[str] = Query(
        None, alias='response-content-language'
    ),
    response_content_type: Optional[str] = Query(None, alias='response-content-type'),
    response_expires: Optional[datetime] = Query(None, alias='response-expires'),
    version_id: Optional[str] = Query(None, alias='versionId'),
    x_amz_server_side_encryption_customer_algorithm: Optional[str] = Header(
        None, alias='x-amz-server-side-encryption-customer-algorithm'
    ),
    x_amz_server_side_encryption_customer_key: Optional[SecretStr] = Header(
        None, alias='x-amz-server-side-encryption-customer-key'
    ),
    x_amz_server_side_encryption_customer_key__m_d5: Optional[str] = Header(
        None, alias='x-amz-server-side-encryption-customer-key-MD5'
    ),
    x_amz_request_payer: Optional[XAmzRequestPayer] = Header(
        None, alias='x-amz-request-payer'
    ),
    part_number: Optional[int] = Query(None, alias='partNumber'),
    x_amz_expected_bucket_owner: Optional[str] = Header(
        None, alias='x-amz-expected-bucket-owner'
    ),
    x_amz_checksum_mode: Optional[XAmzChecksumMode] = Header(
        None, alias='x-amz-checksum-mode'
    ),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def put_object(
    x_amz_acl: Optional[XAmzAcl2] = Header(None, alias='x-amz-acl'),
    bucket: str = Path(..., alias='Bucket'),
    cache__control: Optional[str] = Header(None, alias='Cache-Control'),
    content__disposition: Optional[str] = Header(None, alias='Content-Disposition'),
    content__encoding: Optional[str] = Header(None, alias='Content-Encoding'),
    ...
    x_amz_checksum_crc32: Optional[str] = Header(None, alias='x-amz-checksum-crc32'),
    x_amz_checksum_crc32c: Optional[str] = Header(None, alias='x-amz-checksum-crc32c'),
    x_amz_checksum_sha1: Optional[str] = Header(None, alias='x-amz-checksum-sha1'),
    x_amz_checksum_sha256: Optional[str] = Header(None, alias='x-amz-checksum-sha256'),
    expires: Optional[datetime] = Header(None, alias='Expires'),
    x_amz_grant_full_control: Optional[str] = Header(
        None, alias='x-amz-grant-full-control'
    ),
    x_amz_grant_read: Optional[str] = Header(None, alias='x-amz-grant-read'),
    ...
    x_amz_grant_write_acp: Optional[str] = Header(None, alias='x-amz-grant-write-acp'),
    key: constr(min_length=1) = Path(..., alias='Key'),
    x_amz_server_side_encryption: Optional[XAmzServerSideEncryption] = Header(
        None, alias='x-amz-server-side-encryption'
    ),
    x_amz_storage_class: Optional[XAmzStorageClass] = Header(
        None, alias='x-amz-storage-class'
    ),
    x_amz_website_redirect_location: Optional[str] = Header(
        None, alias='x-amz-website-redirect-location'
    ),
    x_amz_server_side_encryption_customer_algorithm: Optional[str] = Header(
        None, alias='x-amz-server-side-encryption-customer-algorithm'
    ),
    ...
    x_amz_server_side_encryption_aws_kms_key_id: Optional[SecretStr] = Header(
        None, alias='x-amz-server-side-encryption-aws-kms-key-id'
    ),
    x_amz_server_side_encryption_context: Optional[SecretStr] = Header(
        None, alias='x-amz-server-side-encryption-context'
    ),
    x_amz_server_side_encryption_bucket_key_enabled: Optional[bool] = Header(
        None, alias='x-amz-server-side-encryption-bucket-key-enabled'
    ),
    x_amz_request_payer: Optional[XAmzRequestPayer] = Header(
        None, alias='x-amz-request-payer'
    ),
    x_amz_tagging: Optional[str] = Header(None, alias='x-amz-tagging'),
    x_amz_object_lock_mode: Optional[XAmzObjectLockMode] = Header(
        None, alias='x-amz-object-lock-mode'
    ),
    x_amz_object_lock_retain_until_date: Optional[datetime] = Header(
        None, alias='x-amz-object-lock-retain-until-date'
    ),
    x_amz_object_lock_legal_hold: Optional[XAmzObjectLockLegalHold] = Header(
        None, alias='x-amz-object-lock-legal-hold'
    ),
    x_amz_expected_bucket_owner: Optional[str] = Header(
        None, alias='x-amz-expected-bucket-owner'
    ),
...
@app.put(
    ...
    tags=['bucket_acl_management', 'bucket_management', 'bucket_policy_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['multipart_upload_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def get_object_attributes(
    ...
    key: constr(min_length=1) = Path(..., alias='Key'),
    version_id: Optional[str] = Query(None, alias='versionId'),
    x_amz_max_parts: Optional[int] = Header(None, alias='x-amz-max-parts'),
    x_amz_part_number_marker: Optional[int] = Header(
        None, alias='x-amz-part-number-marker'
    ),
    x_amz_server_side_encryption_customer_algorithm: Optional[str] = Header(
        None, alias='x-amz-server-side-encryption-customer-algorithm'
    ),
    ...
    x_amz_object_attributes: XAmzObjectAttributes = Header(
        ..., alias='x-amz-object-attributes'
    ),
...
@app.get(
    ...
    tags=['object_retention_settings', 'object_lock_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def get_object_legal_hold(
    ...
    legal_hold: LegalHold = Query(..., alias='legal-hold'),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def put_object_legal_hold(
    ...
    legal_hold: LegalHold4 = Query(..., alias='legal-hold'),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def upload_part(
    ...
    x_amz_checksum_sha256: Optional[str] = Header(None, alias='x-amz-checksum-sha256'),
    key: constr(min_length=1) = Path(..., alias='Key'),
    part_number: int = Query(..., alias='partNumber'),
...
@app.post(
    ...
    tags=['object_management_operations', 'bucket_versioning_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['object_management_operations', 'object_retention_settings'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['bucket_encryption_settings', 'object_management_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def select_object_content(
    ...
    select: Select = ...,
    select_type: SelectType = Query(..., alias='select-type'),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.delete(
    ...
    tags=['bucket_management', 'bucket_tagging_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.delete(
    ...
    tags=['multipart_upload_management', 'multipart_upload_handling'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
def list_parts(
    ...
    max_parts: Union[
        Optional[int], Optional[str], Optional[str], Optional[str]
    ] = Query(None, alias='max-parts'),
    part_number_marker: Union[
        Optional[int], Optional[str], Optional[str], Optional[str]
    ] = Query(None, alias='part-number-marker'),
    upload_id: str = Query(..., alias='uploadId'),
    x_amz_request_payer: Optional[XAmzRequestPayer] = Header(
        None, alias='x-amz-request-payer'
    ),
...
def create_multipart_upload(
    ...
    x_amz_checksum_algorithm: Optional[XAmzChecksumAlgorithm] = Header(
...
def copy_object(
    ...
    content__language: Optional[str] = Header(None, alias='Content-Language'),
    content__type: Optional[str] = Header(None, alias='Content-Type'),
    x_amz_copy_source: constr(pattern=r'\/.+\/.+') = Header(
        ..., alias='x-amz-copy-source'
    ),
    x_amz_copy_source_if_match: Optional[str] = Header(
        None, alias='x-amz-copy-source-if-match'
    ),
    x_amz_copy_source_if_modified_since: Optional[datetime] = Header(
        None, alias='x-amz-copy-source-if-modified-since'
    ),
    x_amz_copy_source_if_none_match: Optional[str] = Header(
        None, alias='x-amz-copy-source-if-none-match'
    ),
    x_amz_copy_source_if_unmodified_since: Optional[datetime] = Header(
        None, alias='x-amz-copy-source-if-unmodified-since'
    ),
    expires: Optional[datetime] = Header(None, alias='Expires'),
    x_amz_grant_full_control: Optional[str] = Header(
        None, alias='x-amz-grant-full-control'
    ...
    x_amz_grant_write_acp: Optional[str] = Header(None, alias='x-amz-grant-write-acp'),
    key: constr(min_length=1) = Path(..., alias='Key'),
    x_amz_metadata_directive: Optional[XAmzMetadataDirective] = Header(
        None, alias='x-amz-metadata-directive'
    ),
    x_amz_tagging_directive: Optional[XAmzTaggingDirective] = Header(
        None, alias='x-amz-tagging-directive'
    ),
    x_amz_server_side_encryption: Optional[XAmzServerSideEncryption] = Header(
        None, alias='x-amz-server-side-encryption'
    ),
    ...
    x_amz_copy_source_server_side_encryption_customer_algorithm: Optional[str] = Header(
        None, alias='x-amz-copy-source-server-side-encryption-customer-algorithm'
    ),
    x_amz_copy_source_server_side_encryption_customer_key: Optional[SecretStr] = Header(
        None, alias='x-amz-copy-source-server-side-encryption-customer-key'
    ),
    x_amz_copy_source_server_side_encryption_customer_key__m_d5: Optional[str] = Header(
        None, alias='x-amz-copy-source-server-side-encryption-customer-key-MD5'
    ),
    x_amz_request_payer: Optional[XAmzRequestPayer] = Header(
        None, alias='x-amz-request-payer'
    ),
    ...
    x_amz_source_expected_bucket_owner: Optional[str] = Header(
        None, alias='x-amz-source-expected-bucket-owner'
    ),
    x_amz_security_token: Optional[str] = Header(None, alias='x-amz-security-token'),
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.put(
    ...
    tags=['object_copy_operations', 'multipart_upload_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def upload_part_copy(
    ...
    x_amz_copy_source_range: Optional[str] = Header(
        None, alias='x-amz-copy-source-range'
    ),
    key: constr(min_length=1) = Path(..., alias='Key'),
    part_number: int = Query(..., alias='partNumber'),
    upload_id: str = Query(..., alias='uploadId'),
